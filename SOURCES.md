...
| Anthropic | API Release Notes | https://docs.claude.com/en/release-notes/overview |
| Google | Gemini API Changelog | https://ai.google.dev/gemini-api/docs/changelog |
| Google | Gemini App Updates | https://gemini.google/release-notes/ |
...
| Quelle | URL |
|---|---|
| EU AI Act – Kommission | https://digital-strategy.ec.europa.eu/en/policies/regulatory-framework-ai |
